...
def readlines_file(game_story):
    ...
    for story1 in range(18):
        print game_story.readline().strip()     # reads part of the storyline
    starship_future()   # second stage: starship in the future

    for story2 in range(13):
        print game_story.readline().strip()     # reads another part of the storyline
    house_present()     # third stage: house in the present day

    for ending1 in range(10):
        print game_story.readline().strip()
    rooms_timemachine()     # last stage: inside the time machine
